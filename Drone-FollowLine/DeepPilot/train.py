...
if __name__=="__main__":
    ...
    # Load data
    dataset = DeepPilotDataset(path_to_data, transformations, preprocessing=args.preprocess)
    ...
    # Load Model
    pilotModel = DeepPilot(dataset.image_shape).to(device)
    if os.path.isfile( model_save_dir + '/deep_pilot_model_{}.ckpt'.format(random_seed)):
        pilotModel.load_state_dict(torch.load(model_save_dir + '/deep_pilot_model_{}.ckpt'.format(random_seed),map_location=device))
